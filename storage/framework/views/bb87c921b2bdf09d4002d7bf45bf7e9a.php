        ...
        <div class="flex flex-col items-center justify-center px-6  mx-auto py-24 ">
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <?php endif; ?>
                    <form class="space-y-4 md:space-y-6" action="<?php echo e(route("user.register")); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="Write your name" value="<?php echo e(old("name")); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Have an account aready? <a href="<?php echo e(route("user.login")); ?>"
...
<?php echo $__env->make('home.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\learn_laravel\eccom\resources\views/home/register.blade.php ENDPATH**/ ?>