...
<section class="max-sm:hidden">
    ...
    <div class="grid mx-auto container items-center py-4 grid-cols-12 gap-2">
        ...
        <!-- serach field -->
        <div class="relative border ps-3 rounded-full flex justify-center items-center col-span-3">
            <!-- Search Icon -->
            <div
...
<?php /**PATH D:\learn_laravel\eccom\resources\views/home/layouts/header.blade.php ENDPATH**/ ?>